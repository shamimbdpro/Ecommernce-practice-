		...
		<div class="main_menu">
			<nav class="navbar navbar-expand-lg navbar-light main_box">
				<div class="container">
					...
					<a class="navbar-brand logo_h" href="{{URL::to('/')}}"><img src="{{asset('assets/frontend')}}/img/logo.png" alt=""></a>
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						...
						<ul class="nav navbar-nav navbar-right">
							<li class="nav-item"><a href="{{route('addtocart.index')}}" class="cart"><span class="ti-bag" style="color:blue"><b>{{App\Cart::totalitem()==0 ? '' : App\Cart::totalitem()}}</b></span></a></li>
							<li class="nav-item">
